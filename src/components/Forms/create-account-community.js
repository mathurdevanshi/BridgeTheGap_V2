...
export default class CreateCommunityAccount extends Component {
      ...
      <Template>
        <div className="form-container">
          <div style={{ marginTop: 20 }}>
            <h3>Create Account - Community Group/Volunteer</h3>
            <form onSubmit={this.onSubmit}>
              ...
              <div className="form-group">
                <RouterLink component={RouterLink} to="/communityhome">
